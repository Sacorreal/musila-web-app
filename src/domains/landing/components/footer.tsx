      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-sm">{t.footer.description}</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/music/publicar" className="text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Músila. {t.footer.rights}
          </p>
          <div className="flex items-center gap-4">
            <Link
              href="https://www.instagram.com/musila_oficial"
              target="_blank"
            ...
            <Link
              href="https://www.linkedin.com/company/musila"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-foreground transition-colors"
            >
            ...
            <Link
              href="https://www.youtube.com/@Musila-k9l"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-foreground transition-colors"
            >
