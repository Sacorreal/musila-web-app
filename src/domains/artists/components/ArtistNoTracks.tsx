  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      <div className="relative mb-6">
        ...
        <div className="relative w-24 h-24 rounded-full bg-[#1E293B] border border-slate-700 flex items-center justify-center shadow-xl">
          <Music2 className="w-10 h-10 text-slate-500" strokeWidth={1.5} />
        </div>
      </div>
