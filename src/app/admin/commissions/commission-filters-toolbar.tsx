...
import { AffiliateCommissionStatus } from '@/src/domains/admin/commissions/admin-commissions.types'

interface CommissionFiltersToolbarProps {
  status: string
  onStatusChange: (value: string) => void
  onClearFilters: () => void
}

export function CommissionFiltersToolbar({ status, onStatusChange, onClearFilters }: CommissionFiltersToolbarProps) {
  return (
