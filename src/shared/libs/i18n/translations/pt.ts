    ...
    comparator: {
      ...
      rows: [
        ...
        },
        {
          ...
          autor_free: '—',
          autor_pro: 'Ilimitadas (recebe)',
          cantautor_free: 'Até 3',
          cantautor_pro: 'Ilimitadas',
          interprete_free: 'Até 3',
        ...
        },
        {
          ...
          autor_free: '—',
          autor_pro: '—',
          cantautor_free: 'Até 2',
          cantautor_pro: 'Até 5',
          interprete_free: 'Até 2',
          interprete_pro: 'Até 5',
        },
        {
          feature: 'Playlists',
          autor_free: '—',
          autor_pro: '—',
          cantautor_free: 'Até 1',
          cantautor_pro: 'Ilimitadas',
          interprete_free: 'Até 1',
          interprete_pro: 'Ilimitadas',
        },
        {
          feature: 'Pesquisa',
        ...
        },
        {
          ...
          autor_free: 'Grátis',
          autor_pro: 'Mensal',
          cantautor_free: 'Grátis',
          cantautor_pro: 'Mensal',
          interprete_free: 'Grátis',
          interprete_pro: 'Pagamento único',
        },
        {
          feature: 'Preço',
          autor_free: 'Grátis',
          autor_pro: '$39.900 COP/mês',
          cantautor_free: 'Grátis',
          cantautor_pro: '$59.900 COP/mês',
          interprete_free: 'Grátis',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'Sim. Os planos mensais (Autor Pro e Cantautor Pro) podem ser cancelados quando você quiser. Você manterá o acesso até o final do período já pago.',
      },
      {
        question: 'O que inclui o acesso vitalício?',
        answer:
          'O acesso vitalício do Plano Intérprete Pro concede acesso permanente a todas as funcionalidades do plano mediante um único pagamento de $249.900 COP. Não haverá cobranças recorrentes ou renovações.',
      },
      {
