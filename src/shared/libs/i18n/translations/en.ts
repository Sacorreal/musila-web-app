      ...
      rows: [
        {
          ...
          autor_free: 'Up to 3',
          autor_pro: 'Unlimited',
          cantautor_free: 'Up to 3',
          cantautor_pro: 'Unlimited',
          interprete_free: '—',
          interprete_pro: '—',
        },
        {
          ...
          autor_free: '—',
          autor_pro: 'Unlimited (receives)',
          cantautor_free: 'Up to 3',
          cantautor_pro: 'Unlimited',
          interprete_free: 'Up to 3',
          interprete_pro: 'Unlimited',
        },
        {
          feature: 'Collaborators',
          autor_free: '—',
          autor_pro: '—',
          cantautor_free: 'Up to 2',
          cantautor_pro: 'Up to 5',
          interprete_free: 'Up to 2',
          interprete_pro: 'Up to 5',
        },
        {
          feature: 'Playlists',
          autor_free: '—',
          autor_pro: '—',
          cantautor_free: 'Up to 1',
          cantautor_pro: 'Unlimited',
          interprete_free: 'Up to 1',
          interprete_pro: 'Unlimited',
        },
        {
          feature: 'Search',
          autor_free: 'Unlimited',
          autor_pro: 'Unlimited',
          cantautor_free: 'Unlimited',
          cantautor_pro: 'Unlimited',
          interprete_free: 'Unlimited',
          interprete_pro: 'Unlimited',
        },
        {
          ...
          autor_pro: 'Monthly',
          cantautor_free: 'Free',
          cantautor_pro: 'Monthly',
          interprete_free: 'Free',
          interprete_pro: 'One-time',
        },
        {
          feature: 'Price',
          autor_free: 'Free',
          autor_pro: '$39.900 COP/month',
          cantautor_free: 'Free',
          cantautor_pro: '$59.900 COP/month',
          interprete_free: 'Free',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'Yes. Monthly plans (Autor Pro and Cantautor Pro) can be cancelled whenever you wish. You will keep access until the end of the already paid period.',
      },
      {
        question: 'What does lifetime access include?',
        answer:
          'The lifetime access of the Intérprete Pro Plan grants permanent access to all plan features through a single payment of $249,900 COP. There will be no recurring charges or renewals.',
      },
      {
