...
1. Act as the **Product Manager** and execute the `write_specs.md` skill using the `<idea>`.
   _(Wait for the user to explicitly approve the spec. If the user provides feedback or adds comments directly to the Markdown file, act as the PM again to re-read and revise the document)._
